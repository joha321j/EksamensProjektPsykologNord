...
\begin{tabular}[c]{@{}l@{}}Har mange flere udnødvendlige funktioner,\\ som de ikke kan slå fra\end{tabular} & \cellcolor[HTML]{C0C0C0}Mulighed for at få inplemtere mange funktioner \\ \hline
\end{tabular}
\end{table}

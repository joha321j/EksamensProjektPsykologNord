...
\begin{figure}[H]
    \caption{Hjælpemetoder til GetAvailability metoden}
    \centering
        \includegraphics[width=\textwidth]{GetAvailableDateTimes}
        \includegraphics[width=\textwidth]{RemoveBookedDateTimes.png}
    \label{bilag:InformationExpert}
\end{figure}

\subsection{Burndownchart}
\begin{figure}[h]
    \caption{Burndownchart for andet sprint}
    \centering

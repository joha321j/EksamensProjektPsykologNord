...
Istedet deles den store tabel op i mindre tabeller, der indeholder referencer til hinanden.
...
Der eksistere et hav af normalformer, men i denne rapport vil der arbejdes med første, anden og tredje.

Første normalform er opfyldt, når følgende gælder:
\begin{itemize}
    \item Hvis cellerne i en tabel indeholder én værdi
...
Det betyder altså, at det kun er tabeller med sammensatte primærnøgler, der kan være på første normalform uden også at være på anden normalform.
